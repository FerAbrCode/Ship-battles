...
export const AVOIDANCE_RANGE = 120;       // Range to start considering avoidance
export const PREDICTION_TIME = 3.0;       // 3 second prediction
export const MAX_AVOIDANCE_FORCE = 0.25;  // Stronger avoidance
export const ESCORT_LOCK_RADIUS = 100;    // Radius within which escorts lock to commander heading/speed
export const RUDDER_RETURN_RATE = 0.4;   // Very slow return to center
export const ANGULAR_INERTIA = 0.985;    // Very high = extremely smooth turns
export const ANGULAR_ACCEL = 0.8;        // Very low = slow response
export const RUDDER_MOVE_RATE = 0.4;     // Very slow rudder movement
